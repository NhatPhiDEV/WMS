namespace WMS.UI.Forms
{
    partial class Form_Dashboard
    {
        ...
        private void InitializeComponent()
        {
            ...
            ((System.ComponentModel.ISupportInitialize)numQuanlity).BeginInit();
            ...
            panel9.Controls.Add(numQuanlity);
            ...
            // numQuanlity
            // 
            numQuanlity.Font = new Font("Segoe UI", 9.75F);
            numQuanlity.Location = new Point(103, 11);
            numQuanlity.Maximum = new decimal(new int[] { 1661992959, 1808227885, 5, 0 });
            numQuanlity.Minimum = new decimal(new int[] { 1, 0, 0, 0 });
            numQuanlity.Name = "numQuanlity";
            numQuanlity.Size = new Size(66, 25);
            numQuanlity.TabIndex = 6;
            numQuanlity.Value = new decimal(new int[] { 1, 0, 0, 0 });
            // 
            // numQuanlityLimit
            // 
            ...
            numQuanlityLimit.Minimum = new decimal(new int[] { 1, 0, 0, 0 });
            ...
            ((System.ComponentModel.ISupportInitialize)numQuanlity).EndInit();
        ...
        private NumericUpDown numQuanlity;
