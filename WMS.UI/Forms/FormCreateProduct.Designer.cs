namespace WMS.UI.Forms
{
    partial class FormCreateProduct
    {
        ...
        private void InitializeComponent()
        {
            ...
            label1 = new Label();
            NumExpirationDate = new NumericUpDown();
            panel6 = new Panel();
            ...
            ((System.ComponentModel.ISupportInitialize)NumExpirationDate).BeginInit();
            ...
            groupBox4.Controls.Add(NumExpirationDate);
            ...
            // NumExpirationDate
            // 
            NumExpirationDate.Dock = DockStyle.Left;
            NumExpirationDate.Font = new Font("Segoe UI", 9F);
            NumExpirationDate.Location = new Point(3, 20);
            NumExpirationDate.Maximum = new decimal(new int[] { -1981284353, -1966660860, 0, 0 });
            NumExpirationDate.Minimum = new decimal(new int[] { 1, 0, 0, 0 });
            NumExpirationDate.Name = "NumExpirationDate";
            NumExpirationDate.Size = new Size(101, 23);
            NumExpirationDate.TabIndex = 0;
            NumExpirationDate.Value = new decimal(new int[] { 1, 0, 0, 0 });
            // 
            // panel6
            // 
            ...
            ((System.ComponentModel.ISupportInitialize)NumExpirationDate).EndInit();
        ...
        private NumericUpDown NumExpirationDate;
